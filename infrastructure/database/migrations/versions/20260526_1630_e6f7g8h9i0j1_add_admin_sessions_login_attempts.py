...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_admin_login_admin_created", "admin_login_attempts", ["admin_id", "created_at"]
    )
    op.create_index(
        "ix_admin_login_ip_created", "admin_login_attempts", ["ip_address", "created_at"]
    )
    op.create_index(
        "ix_admin_login_status_created", "admin_login_attempts", ["status", "created_at"]
    )
