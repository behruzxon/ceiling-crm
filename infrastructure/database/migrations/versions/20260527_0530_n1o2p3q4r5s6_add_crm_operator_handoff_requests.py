...
def upgrade() -> None:
    ...
    op.create_index("ix_handoff_contact_status", "crm_operator_handoff_requests", ["contact_id", "status"])
    op.create_index("ix_handoff_status_priority_created", "crm_operator_handoff_requests", ["status", "priority", "created_at"])
    op.create_index("ix_handoff_tg_user_status", "crm_operator_handoff_requests", ["telegram_user_id", "status"])
    op.create_index("ix_handoff_created", "crm_operator_handoff_requests", ["created_at"])
    op.create_index("ix_handoff_assigned_status", "crm_operator_handoff_requests", ["assigned_to_admin_id", "status"])
