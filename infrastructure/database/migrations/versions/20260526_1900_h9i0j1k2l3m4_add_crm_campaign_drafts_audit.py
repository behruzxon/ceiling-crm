...
def upgrade() -> None:
    op.create_table("crm_campaign_drafts",
    ...
    op.create_table("crm_campaign_audit_logs",
        sa.Column("id", sa.BigInteger, sa.Identity(), primary_key=True),
    ...
    op.create_index("ix_camp_audit_campaign", "crm_campaign_audit_logs", ["campaign_id", "created_at"])
    op.create_index("ix_camp_audit_actor", "crm_campaign_audit_logs", ["actor_admin_id", "created_at"])
