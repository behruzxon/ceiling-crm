...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("client", "installer", "manager", "admin", "superadmin", name="user_role"),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "scheduled", "running", "done", "failed", name="broadcast_status"),
    ...
    op.create_table(
        ...
        sa.Column(
            "source",
            sa.Enum("group", "site", "ads", "deeplink", "referral", name="lead_source"),
    ...
    op.create_table(
        ...
        sa.Column(
            "type", sa.Enum("measurement", "installation", name="appointment_type"), nullable=False
        ),
    ...
    op.create_index(
        "ix_appointments_installer_date",
        "appointments",
        ["installer_id", "scheduled_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "discount_pct", sa.Numeric(precision=5, scale=2), server_default="0", nullable=False
        ),
