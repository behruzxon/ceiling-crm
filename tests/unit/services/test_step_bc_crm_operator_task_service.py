...
def _c(
    *, status="active", temp="warm", intent=None, objection=None, phone=None, name="Test", cid=1
):
    md = {}
    if intent:
        md["last_intent"] = intent
    if objection:
...
class TestValidation:
    ...
    def test_invalid_type(self):
        assert not svc.is_valid_type("random")
    ...
    def test_invalid_status(self):
        assert not svc.is_valid_status("random")
    ...
    def test_invalid_priority(self):
        assert not svc.is_valid_priority("random")
...
class TestPriorityCalc:
    def test_critical(self):
        assert svc.calculate_task_priority(_c(), "critical") == "urgent"

    def test_danger(self):
        assert svc.calculate_task_priority(_c(), "danger") == "high"

    def test_hot(self):
        assert svc.calculate_task_priority(_c(temp="hot")) == "high"

    def test_warm(self):
        assert svc.calculate_task_priority(_c(temp="warm")) == "normal"

    def test_cold(self):
        assert svc.calculate_task_priority(_c(temp="cold")) == "low"
