...
class TestOwner:
    ...
    def test_crm_reply(self):
        assert svc.has_permission("owner", "crm.reply")

    def test_export_sensitive(self):
        assert svc.has_permission("owner", "crm.export_sensitive")

    def test_rollout_apply(self):
        assert svc.has_permission("owner", "agent.rollout.apply")

    def test_settings_mutate(self):
        assert svc.has_permission("owner", "agent.settings.mutate")


class TestAdmin:
    def test_crm_view(self):
        assert svc.has_permission("admin", "crm.view")

    def test_crm_reply(self):
        assert svc.has_permission("admin", "crm.reply")

    def test_export_sensitive(self):
        assert svc.has_permission("admin", "crm.export_sensitive")

    def test_rollout_apply(self):
        assert svc.has_permission("admin", "agent.rollout.apply")

    def test_approve_delivery(self):
        assert svc.has_permission("admin", "crm.reports.approve_delivery")

    def test_no_admin_permissions(self):
        assert not svc.has_permission("admin", "admin.permissions")


class TestOperator:
    def test_crm_view(self):
        assert svc.has_permission("operator", "crm.view")

    def test_crm_reply(self):
        assert svc.has_permission("operator", "crm.reply")

    def test_crm_tasks(self):
        assert svc.has_permission("operator", "crm.tasks")

    def test_no_export_sensitive(self):
        assert not svc.has_permission("operator", "crm.export_sensitive")

    def test_no_export(self):
        assert not svc.has_permission("operator", "crm.export")

    def test_no_rollout(self):
        assert not svc.has_permission("operator", "agent.rollout.apply")

    def test_no_mutate(self):
        assert not svc.has_permission("operator", "agent.settings.mutate")

    def test_no_delivery_approve(self):
        assert not svc.has_permission("operator", "crm.reports.approve_delivery")


class TestAnalyst:
    def test_crm_view(self):
        assert svc.has_permission("analyst", "crm.view")

    def test_export(self):
        assert svc.has_permission("analyst", "crm.export")

    def test_reports_view(self):
        assert svc.has_permission("analyst", "crm.reports.view")

    def test_no_reply(self):
        assert not svc.has_permission("analyst", "crm.reply")

    def test_no_sensitive(self):
        assert not svc.has_permission("analyst", "crm.view_sensitive")

    def test_no_export_sensitive(self):
        assert not svc.has_permission("analyst", "crm.export_sensitive")

    def test_no_mutate(self):
        assert not svc.has_permission("analyst", "agent.settings.mutate")


class TestViewer:
    def test_crm_view(self):
        assert svc.has_permission("viewer", "crm.view")

    def test_reports_view(self):
        assert svc.has_permission("viewer", "crm.reports.view")

    def test_no_reply(self):
        assert not svc.has_permission("viewer", "crm.reply")

    def test_no_export(self):
        assert not svc.has_permission("viewer", "crm.export")

    def test_no_edit(self):
        assert not svc.has_permission("viewer", "crm.edit")

    def test_no_mutate(self):
        assert not svc.has_permission("viewer", "agent.settings.mutate")
