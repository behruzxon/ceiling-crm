...
class TestConfigSettings:
    def test_mutation_default_false(self):
        ...
        assert BusinessSettings.model_fields["agent_settings_mutation_enabled"].default is False

    def test_confirmation_default_true(self):
        from shared.config.settings import BusinessSettings

        assert BusinessSettings.model_fields["agent_settings_require_confirmation"].default is True

    def test_allow_live_default_false(self):
        from shared.config.settings import BusinessSettings

        assert BusinessSettings.model_fields["agent_settings_allow_live_flags"].default is False
