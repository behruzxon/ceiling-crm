...
class TestSettings:
    ...
    def test_failed_threshold(self):
        ...
        assert (
            BusinessSettings.model_fields["admin_security_failed_login_alert_threshold"].default
            == 5
        )
    ...
    def test_denied_threshold(self):
        ...
        assert (
            BusinessSettings.model_fields[
                "admin_security_permission_denied_alert_threshold"
            ].default
            == 10
        )
    ...
    def test_export_threshold(self):
        ...
        assert (
            BusinessSettings.model_fields["admin_security_sensitive_export_threshold"].default == 3
        )
