...
def _mem() -> dict:
    return {
        "followup_enabled": True, "memory_data": {},
...
class TestSandboxBlocking:
    def test_high_risk_user_dm_blocked(self):
        ex = AgentExecutionSandboxService.prepare_execution(
            {"action": "send_user_reply", "channel": "user_dm",
             "user_message_text": "test", "target_user_id": 123},
    ...
    def test_token_blocked(self):
        ex = AgentExecutionSandboxService.prepare_execution(
            {"action": "send_user_reply", "channel": "user_dm",
             "user_message_text": "sk-secret123", "target_user_id": 123},
            {"followup_enabled": True, "lead_temperature": "warm",
    ...
    def test_phone_blocked(self):
        ex = AgentExecutionSandboxService.prepare_execution(
            {"action": "send_user_reply", "channel": "user_dm",
             "user_message_text": "Call +998901234567", "target_user_id": 123},
            {"followup_enabled": True, "lead_temperature": "warm",
             "followup_count": 0, "memory_data": {}},
            "dry_run",
        )
    ...
    def test_fake_discount_blocked(self):
        ex = AgentExecutionSandboxService.prepare_execution(
            {"action": "send_user_reply", "channel": "user_dm",
             "user_message_text": "20% chegirma!", "target_user_id": 123},
            {"followup_enabled": True, "lead_temperature": "warm",
             "followup_count": 0, "memory_data": {}},
            "dry_run",
        )
    ...
    def test_same_day_blocked(self):
        ex = AgentExecutionSandboxService.prepare_execution(
            {"action": "send_user_reply", "channel": "user_dm",
             "user_message_text": "Bugun qilamiz!", "target_user_id": 123},
            {"followup_enabled": True, "lead_temperature": "warm",
             "followup_count": 0, "memory_data": {}},
            "dry_run",
        )
