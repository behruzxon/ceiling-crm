...
def create_app() -> FastAPI:
    ...
    from apps.api.routes.admin_crm_analytics_summary import (
        router as admin_crm_analytics_summary_router,
    )

    app.include_router(admin_crm_analytics_summary_router)
    ...
    from apps.api.routes.admin_crm_operator_digest import (
        router as admin_crm_operator_digest_router,
    )
