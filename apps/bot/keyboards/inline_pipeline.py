...
def pipeline_actions_keyboard(lead_id: int, current_stage: PipelineStage) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="⏭ Keyingi bosqich", callback_data=f"pipeline:advance:{lead_id}")],
        [InlineKeyboardButton(text="📅 Uchrashuv", callback_data=f"pipeline:schedule:{lead_id}")],
